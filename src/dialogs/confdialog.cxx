...
Fl_Check_Button *chkScampSoftGolay=(Fl_Check_Button *)0;

static void cb_chkScampSoftGolay(Fl_Check_Button* o, void*) {
...
"ver a +/- 10 WPM range.  Calibration/Test is 1 minute of\n\'PARIS \'."));
    ...
    { Fl_Group* o = new Fl_Group(200, 0, 600, 350, gettext("Modem/SCAMP"));
      ...
      { Fl_Check_Button* o = chkScampSoftGolay = new Fl_Check_Button(229, 254, 180, 18, gettext("Soft Golay decoding"));
        chkScampSoftGolay->tooltip(gettext("Use soft-decision Chase decoder for improved performance at low SNR"));
        chkScampSoftGolay->down_box(FL_DOWN_BOX);
        chkScampSoftGolay->callback((Fl_Callback*)cb_chkScampSoftGolay);
