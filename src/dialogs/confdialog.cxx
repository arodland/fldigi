...
\n\nEnter correct CIV address for Icom transceivers."));
    ...
    { Fl_Group* o = new Fl_Group(200, 0, 600, 350, _("Modem/CW/Compensation"));
      o->box(FL_ENGRAVED_BOX);
      o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
      o->hide();
...
ver a +/- 10 WPM range.  Calibration/Test is 1 minute of\n\'PARIS \'."));
    ...
    { Fl_Group* o = new Fl_Group(200, 0, 600, 350, _("Modem/SCAMP"));
      ...
      { Fl_Counter* o = ScampRepeat = new Fl_Counter(399, 203, 75, 22, _("Scamp Repeat Frames"));
...
and improves CWI capture."));
    ...
    { Fl_Group* o = new Fl_Group(200, 0, 600, 350, _("Modem/Wefax"));
      ...
      { Fl_Choice* o = wefax_choice_rx_filter = new Fl_Choice(302, 147, 110, 24, _("Filter"));
      ...
      { Fl_Counter* o = auto_after_nrows = new Fl_Counter(588, 82, 150, 24, _("Enable Auto-align after"));
      ...
      { Fl_Counter* o = align_stop_after = new Fl_Counter(588, 115, 150, 24, _("Stop Auto-align after"));
      ...
      { Fl_Counter* o = align_every_nrows = new Fl_Counter(624, 147, 80, 24, _("Auto-align every"));
      ...
      { Fl_Counter* o = wefax_correlation = new Fl_Counter(589, 180, 150, 24, _("Correlation"));
...
false detections"));
      ...
      { Fl_Choice* o = choice_lpm_288 = new Fl_Choice(302, 180, 110, 24, _("LPM-288"));
        choice_lpm_288->tooltip(_("Set the 288 LPM value"));
      ...
      { Fl_Choice* o = choice_lpm_576 = new Fl_Choice(302, 213, 110, 24, _("LPM-576"));
        choice_lpm_576->tooltip(_("Set the 576 LPM value"));
